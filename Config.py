...
class Config(object):
    ...
    """
    MSG_CODE = {
        1: "This Tool is for Mostfun Control Panel Check, Update and Rollback",
        2: "Tool command args",
        3: "Update the control panel package. "
           "Input the source folder and target filder.",
        4: "package folder path",
        5: "backup folder path",
        6: "zip file path *and* file name",
        7: "Rollback the control panel package "
           "to the last stable version.",
        8: "Check the control panel package's integrity.",
